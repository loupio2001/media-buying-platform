...
class PlatformConnectionUpsertRequest extends FormRequest
{
    ...
    {
        $platformConnectionId = $this->route('platform_connection')?->id ?? $this->route('platform_connection');
        ...
        return [
            ...
            'account_id' => [
                ...
                Rule::unique('platform_connections', 'account_id')
                    ->where(fn ($query) => $query->where('platform_id', $this->input('platform_id')))
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            $platformConnection = $this->route('platform_connection');
