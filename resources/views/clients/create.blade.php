...
@section('title', 'New Client | Havas Media Buying Platform')

@section('content')
    <section class="space-y-6">
        <div>
            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-orange-300">Clients</p>
            <h1 class="mt-2 text-3xl font-semibold text-white">Create Client</h1>
        </div>
        ...
        <form method="POST" action="{{ route('web.clients.store') }}" class="space-y-5 rounded-xl border border-slate-800 bg-slate-900/80 p-6">
            @csrf
